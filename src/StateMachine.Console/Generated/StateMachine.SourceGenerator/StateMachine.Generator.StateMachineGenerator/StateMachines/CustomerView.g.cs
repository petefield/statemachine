...
public partial class CustomerView : IStateMachine<CustomerState> 
{
	private List<ITransition<CustomerView, CustomerState>> Transitions => [
		 ...
		 new Transition<AccountClosed, CustomerView, CustomerState>(CustomerState.Customer, CustomerState.Former, (subject, evt) =>  subject.AccountsHeld == 1, "subject.AccountsHeld == 1"),
		 new Transition<AccountClosed, CustomerView, CustomerState>(CustomerState.Customer, CustomerState.Customer, (subject, evt) =>  subject.AccountsHeld !=1, "subject.AccountsHeld !=1"),
